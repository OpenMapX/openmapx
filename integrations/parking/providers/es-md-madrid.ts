...
const reader = createStaticPoiReader<ParkingFacility>({
  sourceId: "es-md-madrid",
  mapStatic: mapEsMdMadridPayload,
...
export async function searchEsMdMadrid(bbox: BoundingBox): Promise<ParkingFacility[]> {
  return reader.search(getRuntimeContext(), toBboxTuple(bbox));
}

export async function fetchEsMdMadridDetail(id: string): Promise<ParkingFacility | null> {
