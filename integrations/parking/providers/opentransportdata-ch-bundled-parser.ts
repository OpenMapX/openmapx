 ...
 * `resolveOpenTransportDataChDownloadUrl` export, registered in
 ...
 */
export async function resolveOpenTransportDataChDownloadUrl(log: PoiSourceLogger): Promise<string> {
  try {
...
export const parseOpenTransportDataChBundled: PoiBundledParseFn = (buffer, { log }) => {
