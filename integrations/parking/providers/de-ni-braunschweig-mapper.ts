...
const SOURCE_ID = "de-ni-braunschweig";
const MAX_LIVE_AGE_MS = 30 * 60 * 1000;

export function mapDeNiBraunschweigPayload(poiId: string, payload: unknown): ParkingFacility {
...
export function mergeDeNiBraunschweigLive(
