...
const STATION_ID_PREFIX = "de-nw-mobidrom-pr:";
...
export async function searchDeNwMobidromPr(bbox: BoundingBox): Promise<ParkingFacility[]> {
  return reader.search(getRuntimeContext(), toBboxTuple(bbox));
}

export async function fetchDeNwMobidromPrDetail(
  externalId: string,
