...
const SOURCE_ID = "it-32-opendatahub";

export function mapIt32OpendatahubPayload(poiId: string, payload: unknown): ParkingFacility {
...
export function mergeIt32OpendatahubLive(
