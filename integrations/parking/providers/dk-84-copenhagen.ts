...
const STATION_ID_PREFIX = "dk-84-copenhagen:";

const reader = createStaticPoiReader<ParkingFacility>({
  sourceId: "dk-84-copenhagen",
  mapStatic: mapDk84CopenhagenPayload,
...
export async function searchDk84Copenhagen(bbox: BoundingBox): Promise<ParkingFacility[]> {
  return reader.search(getRuntimeContext(), toBboxTuple(bbox));
}

export async function fetchDk84CopenhagenDetail(id: string): Promise<ParkingFacility | null> {
