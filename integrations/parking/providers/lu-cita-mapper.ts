...
export function mapLuCitaPayload(poiId: string, payload: unknown): ParkingFacility {
...
export function mergeLuCitaLive(base: ParkingFacility, live: PoiLiveState | null): ParkingFacility {
  if (!live) return base;
